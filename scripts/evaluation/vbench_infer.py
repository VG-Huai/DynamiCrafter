...
def load_data_prompts():
    ...
    dimensions = ['subject_consistency', 'background_consistency', 'motion_smoothness',
                  'dynamic_degree', 'aesthetic_quality', 'imaging_quality', 'i2v_subject', 'i2v_background', 'camera_motion']
    data_list = []
    filename_list = []
    prompt_list = []
    for dimension in dimensions:
        image_folder = "/mnt/ssd_2/ehliu/projects/VBench/vbench2_beta_i2v/data/crop/8-5" # resolution = 1-1/8-5/7-4/16-9
        info_list = json.load(open("/mnt/ssd_2/ehliu/projects/VBench/vbench2_beta_i2v/vbench2_i2v_full_info.json", "r"))
...
def run_inference(args, gpu_num, gpu_no):
    ...
    transform = transforms.Compose([
        transforms.Resize(min((args.height, args.width))),
